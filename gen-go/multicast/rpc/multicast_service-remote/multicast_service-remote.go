...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  SendDataResponse sendData(SendDataRequest req)")
  fmt.Fprintln(os.Stderr, "  SendSeqResponse sendSeq(SendSeqRequest req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := rpc.NewMulticastServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "sendData":
    ...
    argvalue0 := rpc.NewSendDataRequest()
  ...
  case "sendSeq":
    ...
    argvalue0 := rpc.NewSendSeqRequest()
